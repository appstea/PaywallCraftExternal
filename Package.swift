...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/RevenueCat/purchases-ios.git", .upToNextMajor(from: "5.44.1")),
      .package(url: "https://github.com/ashleymills/Reachability.swift", branch: "main"),
