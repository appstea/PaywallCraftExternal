...
public enum L10n {
  ...
  public enum DefaultUpsell {
    ...
    public enum Upgrade {
      /// UPGRADE
      public static let title = L10n.tr("Localizable", "default_upsell.upgrade.title")
    }
  }
  ...
  public enum Paywall {
    ...
    public static func pricePerPeriod(_ p1: Any, _ p2: Any) -> String {
      return L10n.tr("Localizable", "paywall.price_per_period", String(describing: p1), String(describing: p2))
    }
    /// %@/%@
    ...
    public enum AdditionalOffer {
      ...
      public static func textFormat(_ p1: Any) -> String {
        return L10n.tr("Localizable", "paywall.additional_offer.text_format", String(describing: p1))
      }
      /// Not convinced?
      public static let title = L10n.tr("Localizable", "paywall.additional_offer.title")
    }
    public enum Button {
      /// Remind me when internet connection is back
      public static let noInternet = L10n.tr("Localizable", "paywall.button.no_internet")
      /// Privacy
      public static let privacy = L10n.tr("Localizable", "paywall.button.privacy")
      /// Restore
      public static let restore = L10n.tr("Localizable", "paywall.button.restore")
      /// Terms
    ...
    public enum OneButton {
      ...
      /// Unlimited access\nto all features
      public static let title = L10n.tr("Localizable", "paywall.one_button.title")
      public enum Button {
        /// or continue with a limited version
        public static let close = L10n.tr("Localizable", "paywall.one_button.button.close")
        /// Continue
        public static let `continue` = L10n.tr("Localizable", "paywall.one_button.button.continue")
      }
      public enum Feature {
        /// Enjoy all features of the app
        public static let first = L10n.tr("Localizable", "paywall.one_button.feature.first")
        /// Remove ads
        public static let second = L10n.tr("Localizable", "paywall.one_button.feature.second")
      }
      public enum Trial {
        /// Then %@ per %@
        public static func actual(_ p1: Any, _ p2: Any) -> String {
          return L10n.tr("Localizable", "paywall.one_button.trial.actual", String(describing: p1), String(describing: p2))
        }
        /// %d days trial
        public static func free(_ p1: Int) -> String {
          return L10n.tr("Localizable", "paywall.one_button.trial.free", p1)
        }
      }
    }
    public enum Period {
      /// day
      public static let day = L10n.tr("Localizable", "paywall.period.day")
      /// month
      public static let month = L10n.tr("Localizable", "paywall.period.month")
      /// quarter
      public static let quartal = L10n.tr("Localizable", "paywall.period.quartal")
      /// week
      public static let week = L10n.tr("Localizable", "paywall.period.week")
      /// year
      public static let year = L10n.tr("Localizable", "paywall.period.year")
    }
    public enum TwoButtons {
      /// That's just %@
      public static func infoJust(_ p1: Any) -> String {
        return L10n.tr("Localizable", "paywall.two_buttons.info_just", String(describing: p1))
      }
      /// Try For Free
      public static let subtitle = L10n.tr("Localizable", "paywall.two_buttons.subtitle")
      ...
      public static let text = L10n.tr("Localizable", "paywall.two_buttons.text")
      ...
      public static func textFormat(_ p1: Int, _ p2: Any) -> String {
        return L10n.tr("Localizable", "paywall.two_buttons.text_format", p1, String(describing: p2))
      }
      /// Enjoy all features of the app ad free and make sure that all new features are unlocked for you to use. Try %d days free, then %@. No commitment. Cancel anytime.
      public static func textFormat7(_ p1: Int, _ p2: Any) -> String {
        return L10n.tr("Localizable", "paywall.two_buttons.text_format7", p1, String(describing: p2))
      }
      /// Full Access
